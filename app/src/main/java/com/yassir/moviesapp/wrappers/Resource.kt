...
import com.yassir.moviesapp.interceptors.NoInternetException
import com.yassir.moviesapp.utils.MovieApplication
...
class NoResponseBodyException : IOException() {
    override val message: String
        get() = MovieApplication.context.getString(R.string.no_response_body)
}
